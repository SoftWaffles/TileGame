...
public class BGrassCLD extends StaticEntity {

    public BGrassCLD(Handler handler, float x, float y){
    ...
    public void render(Graphics g){
        ...
        g.drawImage(Assets.bGrass_CLD, (int)(x-handler.getCamera().getxOffset()),
