...
public class BGrassCL extends StaticEntity {

    public BGrassCL(Handler handler, float x, float y){
    ...
    public void render(Graphics g){
        ...
        g.drawImage(Assets.bGrass_CL, (int)(x-handler.getCamera().getxOffset()),
