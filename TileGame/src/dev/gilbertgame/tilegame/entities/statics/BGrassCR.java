...
public class BGrassCR extends StaticEntity {

    public BGrassCR(Handler handler, float x, float y){
    ...
    public void render(Graphics g){
        ...
        g.drawImage(Assets.bGRass_CR, (int)(x-handler.getCamera().getxOffset()),
