...
public class BGrassRB extends StaticEntity {

    public BGrassRB(Handler handler, float x, float y){
    ...
    public void render(Graphics g){
        ...
        g.drawImage(Assets.bGrass_RB, (int)(x-handler.getCamera().getxOffset()),
