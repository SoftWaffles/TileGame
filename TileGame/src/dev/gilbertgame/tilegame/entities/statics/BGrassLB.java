...
public class BGrassLB extends StaticEntity {

    public BGrassLB(Handler handler, float x, float y){
    ...
    public void render(Graphics g){
        ...
        g.drawImage(Assets.bGrass_LB, (int)(x-handler.getCamera().getxOffset()),
