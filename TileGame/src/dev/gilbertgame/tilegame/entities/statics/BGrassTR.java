...
public class BGrassTR extends StaticEntity {

    public BGrassTR(Handler handler, float x, float y){
    ...
    public void render(Graphics g){
        ...
        g.drawImage(Assets.bGrass_TR, (int)(x-handler.getCamera().getxOffset()),
