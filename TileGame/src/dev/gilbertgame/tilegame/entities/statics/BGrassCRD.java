...
public class BGrassCRD extends StaticEntity {

    public BGrassCRD(Handler handler, float x, float y){
    ...
    public void render(Graphics g){
        ...
        g.drawImage(Assets.bGrass_CRD, (int)(x-handler.getCamera().getxOffset()),
